    ...
    async function loadContent() {
      try {
        const { data, error } = await supabase
          .from('site_settings')
          .select('privacy_policy, copyright_last_review_date')
          .eq('id', 'default')
          .maybeSingle();
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO
        ...
        description="Privacy policy for MediWaste clinical waste disposal services. Learn how we collect, use, and protect your personal data."
        canonical="https://mediwaste.co.uk/privacy"
        noindex={true}
      />

      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><Link to="/audit" className="hover:text-white">Clinical Waste Audit</Link></li>
        ...
        <div className="border-t border-gray-800 pt-8">
          ...
          <p className="text-center text-xs text-gray-500 mt-3">
            MediWaste is a trading name of Circular Horizons International Ltd, registered in England and Wales under Company Number 15821509. VAT Number 522913113. Registered office: Unit 2 Capital Industrial Estate, Crabtree Manorway South, Belvedere, Kent, England, DA17 6BJ
          </p>
        </div>
      </div>
    </footer>
